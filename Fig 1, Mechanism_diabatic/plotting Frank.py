...
fig, ax = plt.subplots(1, 1, figsize=(0.85 * unitlen, 0.85 * unitlen), dpi = 128, sharey = 'row')
...
# plt.plot(1.05*arrowrange, func1(arrowrange), lw = 2.5, color = 'black')
arrowline(ax, arrowrange, func1(arrowrange), style='to', arrow_size = 1, arrow_style='above', arrow_angle = 120, color = 'black')
arrowline(ax, arrowrange, func1(arrowrange), style='to', arrow_size = 1, arrow_style='below', arrow_angle = 0, color = 'black')

arrowrange = [-1.2] * 1000
plt.plot(arrowrange, np.linspace(0, wc / cm_to_au, 1000), lw = 2.5, color = 'red')
arrowline(ax, arrowrange, np.linspace(0, wc / cm_to_au, 1000), style='to', arrow_size = 2, arrow_style='full', arrow_angle = 30, color = 'red')
