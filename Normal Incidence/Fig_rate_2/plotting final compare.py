...
fig, ax = plt.subplots(figsize=(4.0 * unitlen, 1.0 * unitlen), dpi = 512, sharey = 'row')
...
plt.text(1360, 1.9, r'$\omega_\mathrm{0}$', color = 'black', size = 20)
plt.text(1270, 1.8, r'$1190\ \mathrm{cm}^{-1}$', color = 'black', size = 20)
plt.text(1280, 1.3, r'$\mathcal{D} / c = 1$ fs', color = 'black', size = 24)
...
Gamma_perpendicular = 1.0 / tau_c
# tau_0 = 3.33333333333e1 * fs_to_au
tau_0 = 3.33333333333e0 * fs_to_au
temp = 1. / beta
...
plt.text(1360, 1.9, r'$\omega_\mathrm{0}$', color = 'black', size = 20)
plt.text(1270, 1.8, r'$1190\ \mathrm{cm}^{-1}$', color = 'black', size = 20)
plt.text(1250, 1.3, r'$\mathcal{D} / c = 3.33$ fs', color = 'black', size = 24)
...
plt.text(1360, 1.9, r'$\omega_\mathrm{0}$', color = 'black', size = 20)
plt.text(1270, 1.8, r'$1190\ \mathrm{cm}^{-1}$', color = 'black', size = 20)
plt.text(1250, 1.3, r'$\mathcal{D} / c = 33.3$ fs', color = 'black', size = 24)
...
plt.savefig("figure_rate_2_compare.pdf", bbox_inches='tight')